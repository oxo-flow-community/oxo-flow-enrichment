...
# Port of upstream workflow/scripts/gene_preranked_GSEApy.py.
# snakemake.input['query_genes'|'database'], snakemake.output['result_file']
# and snakemake.params['database'] become positional CLI arguments
# <query_genes> <database> <result> <db>.
