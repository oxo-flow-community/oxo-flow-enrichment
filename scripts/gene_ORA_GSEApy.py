...
# Port of upstream workflow/scripts/gene_ORA_GSEApy.py.
# snakemake.input['query_genes'|'background_genes'|'database'],
# snakemake.output['result_file'] and snakemake.params['database'] become
# positional CLI arguments <query_genes> <background_genes> <database>
# <result> <db>.
...
# input
query_genes_path = sys.argv[1]
background_genes_path = sys.argv[2]
